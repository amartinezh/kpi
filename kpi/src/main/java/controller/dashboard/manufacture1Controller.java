...
public class manufacture1Controller {

	@Autowired
	private Manufactura1Service manufactureService;
	...
	public String distriYear(Model model, @RequestParam String t, @RequestParam String op10) {
		if (model.containsAttribute("user_inicio") == true) {
			...
			List<reporteManufacture1> listado3 = manufactureService.listSales((session) model.asMap().get("user_inicio"),"Manufacture3");
			List<reporteManufacture1> listado4 = manufactureService.listSales((session) model.asMap().get("user_inicio"),"Manufacture4");
			List<reporteManufacture1> listado5 = manufactureService.listSales((session) model.asMap().get("user_inicio"),"Manufacture5");
			List<reporteManufacture1> listado6 = manufactureService.listSales((session) model.asMap().get("user_inicio"),"Manufacture6");
			List<reporteManufacture1> listado7 = manufactureService.listSales((session) model.asMap().get("user_inicio"),"Manufacture7");
			List<reporteManufacture1> listado8 = manufactureService.listSales((session) model.asMap().get("user_inicio"),"Manufacture8");
			List<reporteManufacture1> listado9 = manufactureService.listSales((session) model.asMap().get("user_inicio"),"Manufacture9");
	...
	@RequestMapping(value = "/manuMonth", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/manuQuarterly", method = RequestMethod.GET)
	...
	public String drilldown(@RequestParam String m3r, @RequestParam String ind1c4, @RequestParam String ind1c4d3s, @RequestParam String ll4v3, @RequestParam String d3s, @RequestParam String op10n, @RequestParam String s1m, @RequestParam String op3r, Model model) {
		if (model.containsAttribute("user_inicio") == true) {
			...
			if (op10n.equals("M")){
				model.addAttribute("valor", manufactureService.listSalesDrillMonth((session) model.asMap().get("user_inicio"),"Manufacture1"));
				return "drilldownMonth";
			}
			else{
				if (op10n.equals("Q")){
					model.addAttribute("valor", manufactureService.listSalesDrillQuarterly((session) model.asMap().get("user_inicio"),"Manufacture1"));
					model.addAttribute("totales",((session) model.asMap().get("user_inicio")).getTotales());
					return "drilldownQuarterly";
				}
				else{
					if (op10n.equals("Y")){
						model.addAttribute("valor", manufactureService.listSalesDrill((session) model.asMap().get("user_inicio"),"Manufacture1"));
						model.addAttribute("totales",((session) model.asMap().get("user_inicio")).getTotales());
						return "drilldown";
					}
					else{
