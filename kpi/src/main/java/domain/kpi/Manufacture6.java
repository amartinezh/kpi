...
@Table(name = "indman6", schema = "man")
public class Manufacture6 {
	...
	public Manufacture6(String mveano, String mvemes) {
		this.mveano = mveano;
		this.mvemes = mvemes;
	...
	public Manufacture6(String mveano, String mvemes, BigDecimal mveval, BigDecimal mvevac, BigDecimal mvevap,
			BigDecimal mvevpe) {
		super();
		this.mveano = mveano;
		this.mvemes = mvemes;
