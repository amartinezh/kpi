...
@Table(name = "indman9", schema = "man")
public class Manufacture9 {
	...
	public Manufacture9(String mveano, String mvemes) {
		this.mveano = mveano;
		this.mvemes = mvemes;
	...
	public Manufacture9(String mveano, String mvemes, BigDecimal mveval, BigDecimal mvevac, BigDecimal mvevap,
			BigDecimal mvevpe) {
		super();
		this.mveano = mveano;
		this.mvemes = mvemes;
