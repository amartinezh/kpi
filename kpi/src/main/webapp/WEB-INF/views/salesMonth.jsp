...
<body>
				...
				<tbody>
					<c:forEach items="${valor}" var="kpi"
						...
						<tr class="${color}">
							...
							<td>
								<img onclick="drilldown('${ kpi.ind_cod }', '${ kpi.operacion}')" src="<c:url value="/resources/img/adm/plan.png"/>" alt="Graficos" style="width: 20px; height:20px; margin-top: 3px; margin-right: 10px;">
	...
	<script type="text/javascript">
		...
		function drilldown_controller(indicador, nombre_filtro, campo_llave, campo_des, indicador_des, sim, op3r) {
			...
			window.location="drilldown?m3r="+nombre_filtro+"&ind1c4="+indicador+"&ind1c4d3s="+encodeURIComponent(indicador_des)+"&ll4v3="+campo_llave+"&d3s="+campo_des+"&op10n=M"+"&s1m="+sim+"&op3r="+op3r;
		}
