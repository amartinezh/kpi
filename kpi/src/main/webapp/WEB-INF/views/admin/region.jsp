...
<body class="">
											...
											<div class="form-group">
												<div class="row">
													<div class="col-md-12 has-feedback">
														 ...
														 <form:input path="region_id" type="text"
					...
					<div class="widget-body no-padding">
						...
						<div id="datatable_fixed_column_wrapper"
							...
							<table id="datatable_fixed_column" name="datatable_fixed_column"
								...
								<tbody>
									<c:forEach items="${listRegion}" var="obj"
										varStatus="loopCounter">
										<tr role="row" class="odd">
											<td class="sorting_1"><span class="responsiveExpander"></span>
												<a class="btn btn-success btn-circle btn-sx"
												onclick="con('<c:out value="${obj.region_id}"></c:out>','<c:out value="${obj.descripcion}"></c:out>',$(this))">
												<i class="fa fa-edit"></i></a> <a
												class="btn btn-danger btn-circle"
												onclick="borrar(<c:out value="${obj.region_id}"></c:out>, $(this))">
	...
	<script type="text/javascript">
		...
		function con(acti_id, descripcion, thi) {
			document.getElementById('region_id').value=acti_id;
