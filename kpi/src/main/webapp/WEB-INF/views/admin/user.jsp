											...
											<div class="form-group">
												<div class="row">
													...
													<div class="col-md-12 has-feedback">
														 ...
														 <form:input path="pass" type="text"
															class="form-control" data-bv-field="Pass"
															required="required" /> 
													</div>
													<div class="col-md-12 has-feedback">
														<label class="control-label">Type User</label>
														<form:select path="type" class="form-control">
													    	<form:options items="${cmbTypeUser}"></form:options>
														</form:select>
													</div>
													<div class="col-md-12 has-feedback">
														<label class="control-label">Company</label>
														<form:select path="comp" class="form-control">
													    	<form:options items="${cmbCompany}"></form:options>
														</form:select>
													</div>
													<div class="col-md-12 has-feedback">
