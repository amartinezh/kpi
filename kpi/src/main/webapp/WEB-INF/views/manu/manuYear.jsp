...
<body>
					...
					<div class="row">
					 ...
					 -->
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false">
								...
								<header>
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
									<h2><strong>Destinct</strong> <i>Plant</i></h2>
					...
					$('#show-tabs').click(
							function() {
								...
								if ($this.prop('checked')) {
									$("#widget-tab-1").removeClass("nav-pills")
											.addClass("nav-tabs");
								} else {
									$("#widget-tab-1").removeClass("nav-tabs")
											.addClass("nav-pills");
								}
	...
	<script type="text/javascript">
		...
		function drilldown_controller(indicador, nombre_filtro, campo_llave,
				campo_des, indicador_des, sim) {
			...
			window.location = "drilldown?m3r=" + nombre_filtro + "&ind1c4="
					...
					+ campo_llave + "&d3s=" + campo_des + "&op10n=Y" + "&s1m="
					+ sim;
		}

		function opciones_detalle(indicador, indicador_des, cosa_this) {
			var opc = new Array();
			var simbolo_porcentaje = $(cosa_this).closest("tr")
					.find('td:eq(1)').text();
