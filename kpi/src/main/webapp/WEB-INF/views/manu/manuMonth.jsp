	...
	<div id="mainn" role="mainn">
										...
										<table id="tbl" class="table table-bordered" width="100%">
											<thead>
												...
												<tr>
													...
													<th colspan="2" style="text-align: center; color: blue;">${elmes}
														<c:out value="${anio}" />
													</th>
												...
												<c:forEach items="${valor}" var="kpi"
													...
													<tr class="${color}">
														...
														<td rowspan="2"><a id="modal" href="#"
															onclick="drilldown('${ kpi.ind_cod }', '${ kpi.operacion}', this)">${ kpi.ind }</a>
														...
														<td><img
															...
															alt="Graficos"
															style="width: 20px; height: 20px; margin-top: 3px; margin-right: 10px;">
														</td>
		...
		<script type="text/javascript">
			...
			function drilldown_controller(indicador, nombre_filtro,
					campo_llave, campo_des, indicador_des, sim, op3r) {
				...
				window.location = "drilldown?m3r=" + nombre_filtro + "&ind1c4="
						...
						+ campo_llave + "&d3s=" + campo_des + "&op10n=M"
						+ "&s1m=" + sim + "&op3r=" + op3r;
			}

			function opciones_detalle(indicador, operacion, indicador_des,
					cosa_this) {
				var opc = new Array();
			...
			function drilldown(indicador, operacion, cosa) {
				$("#opc").html('');
				$("#opc").append(
						opciones_detalle(indicador, operacion, cosa.innerHTML,
								cosa));
				//tit=cosa.innerHTML;
