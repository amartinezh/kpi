	...
	<div>
		...
		<div id="content">
							...
							<div role="content">
								...
								<div class="widget-body">
									<form:form id="frm" method="post" class="bv-form"
										ModelAttribute="plan" commandName="plan">
										<button type="submit" class="bv-hidden-submit"
											style="display: none; width: 0px; height: 0px;"></button>
										<fieldset>
											<legend> Planes de Acción </legend>
											<div class="form-group">
												<div class="row">
													<div class="col-md-12 has-feedback">
														<form:input type="hidden" path="plan_id" value="0" />
														<form:input type="hidden" path="estado" />
														
														<label class="control-label">indicador</label>
														<form:input path="indicador" type="text"
															class="form-control" data-bv-field="Indicador"
															required="required" />
													</div>
												</div>
											</div>
										...
										<fieldset>
											<div class="form-group">
												<div class="row">
													<div class="col-md-4">
														<label class="control-label">problema_encontrado</label>
														<form:input path="problema_encontrado" type="text"
															class="form-control" data-bv-field="problema_encontrado"
															required="required" />
													</div>
													<div class="col-md-4">
														<label class="control-label">impacto_discrepancia</label>
														<form:input path="impacto_discrepancia" type="text"
															class="form-control" data-bv-field="impacto_discrepancia"
															required="required" />
													</div>
													<div class="col-md-4">
														<label class="control-label">plan_accion</label>
														<form:input path="plan_accion" type="text"
															class="form-control" data-bv-field="plan_accion"
															required="required" />
													</div>
												</div>
											</div>
												...
												<div class="row">
													<div class="col-md-4">
														...
														<form:input path="tipo" type="text"
															class="form-control" data-bv-field="tipo"
															required="required" />
													</div>
													<div class="col-md-4">
														<label class="control-label">responsable</label>
														<form:input path="responsable" type="text"
															class="form-control" data-bv-field="responsable"
															required="required" />
													</div>
													<div class="col-md-4">
														<label class="control-label">resultado_esperado</label>
														<form:input path="resultado_esperado" type="text"
															class="form-control" data-bv-field="resultado_esperado"
															required="required" />
													</div>
												</div>
											</div>
										...
										<fieldset>
											<div class="form-group">
												<div class="row">
													<div class="col-md-4">
														<label class="control-label">fecha_compromiso</label>
														<form:input path="fecha_compromiso" type="text"
															class="form-control" data-bv-field="fecha_compromiso"
															required="required" />
													</div>
													<div class="col-md-4">
														<label class="control-label">estado</label>
														<form:input path="estado" type="text"
															class="form-control" data-bv-field="estado"
															required="required" />
													</div>
												</div>
											</div>
			...
			<div
					...
					<div class="widget-body no-padding">
						...
						<div id="datatable_fixed_column_wrapper"
							...
							<table id="datatable_fixed_column" name="datatable_fixed_column"
								...
								<tbody>
									<c:forEach items="${listPlan}" var="obj"
										varStatus="loopCounter">
										<tr role="row" class="odd">
											<td class="sorting_1"><span class="responsiveExpander"></span>
												<a class="btn btn-success btn-circle btn-sx"
												onclick="con('<c:out value="${obj.plan_id}"></c:out>','<c:out value="${obj.indicador}"></c:out>',$(this))"><i
													class="fa fa-edit"></i></a> <a
												class="btn btn-danger btn-circle"
												onclick="borrar(<c:out value="${obj.plan_id}"></c:out>, $(this))"><i
													class="fa fa-trash-o"></i></a></td>
											<td class="sorting_1"><span class="responsiveExpander"></span>
												<c:out value="${obj.indicador}"></c:out></td>
										</tr>
									</c:forEach>
								</tbody>
				...
				<!-- end widget div -->
rm /var/www/html/kpi/DatosCargar.txt;
./kipActualizar.sh
			</div>
	...
	<script type="text/javascript">
		...
		function actualizar() {
			...
			var problema_encontrado = document.getElementById('problema_encontrado').value;
			var impacto_discrepancia = document.getElementById('impacto_discrepancia').value;
			var plan_accion = document.getElementById('plan_accion').value;
			var tipo = document.getElementById('tipo').value;
			var responsable = document.getElementById('responsable').value;
			var resultado_esperado = document.getElementById('resultado_esperado').value;
			var fecha_compromiso = document.getElementById('fecha_compromiso').value;
			...
			$.ajax({
				...
				data : {
					...
					impacto_discrepancia: impacto_discrepancia,
		...
		function con(plan_id, indicador, problema_encontrado, fecha, problema_encontrado, impacto_discrepancia, plan_accion, tipo, responsable, resultado_esperado, fecha_compromiso, estado, thi) {
			document.getElementById('plan_id').value=plan_id;
			document.getElementById('indicador').value=indicador;
			document.getElementById('problema_encontrado').value=problema_encontrado;
			document.getElementById('fecha').value=fecha;
			document.getElementById('problema_encontrado').value=problema_encontrado;
			document.getElementById('impacto_discrepancia').value=impacto_discrepancia;
			document.getElementById('plan_accion').value=plan_accion;
			document.getElementById('tipo').value=tipo;
			document.getElementById('responsable').value=responsable;
			document.getElementById('resultado_esperado').value=resultado_esperado;
			document.getElementById('fecha_compromiso').value=fecha_compromiso;
