		...
		<div class="pull-right">
			...
			<div class="pull-left">
				<div class="form-inline">
					...
					<select class="form-control input-sm col-sm-2" id="region" class="region"
						name="region" onclick="cargaRegiones()">
						<option value="Todas">-All-</option>
						<c:forEach items="${regionList}" var="reg"
							varStatus="loopCounter">
							<option value="${reg.region_id}">${reg.descripcion}</option>
						</c:forEach>
					</select> 
					<select class="form-control input-sm col-sm-2" id="nia" class="nia"
						name="nia" onclick="cia()">
						<option value="Todas">-All-</option>
					...
					<select class="form-control input-sm col-sm-2" id="moneda" class="moneda"
						name="moneda" onclick="moneda()">
						<c:forEach items="${currencyList}" var="curr"
							varStatus="loopCounter">
							<option value="${curr.id}">${curr.descripcion}</option>
						</c:forEach>
					</select> <select class="form-control input-sm col-sm-2" id="tasa" class="tasa"
